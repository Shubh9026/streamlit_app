...
def load_ocr_reader():
    try:
        ...
        logging.error(f"Error loading OCR reader: {str(e)}")  # Log to terminal
        return None
...
def perform_ocr(image):
    ...
    try:
        ...
        logging.error(f"Error in OCR processing: {str(e)}")  # Log to terminal
        logging.error(traceback.format_exc())  # Log traceback to terminal
        return None
...
if uploaded_image:
    try:
        ...
        logging.error(f"An error occurred while processing the image: {str(e)}")  # Log to terminal
